...
class Student:
    def __init__(self,root):
        ...
        Manage_frame.place(x=1, y=1, width=1279, height=85)

        title = Label(Manage_frame, text="Student Management System", bd=7,
                      relief=SUNKEN, width=40,
                      font=("times new roman",35,"bold"),bg="light green", fg="black")
        title.pack(side=LEFT)

        home_button = Button(Manage_frame, fg="black", bg="tomato",
                             text="HOME PAGE >>",
        ...
        lbl_Contact = Label(Manage_Frame, text="Contact No", bg="crimson", fg="white",
                         font=("times new roman", 20, "bold"))
        ...
        Detail_Frame.place(x=500,y=100,width=760,height=585)
        ...
        Table_Frame.place(x=10, y=70, width=730, height=500)
